...
#' @param FUN the function used to calculate the number of oviposition events (default = `TP``)
#'
#' @return a vector of relative fitness (calculated from the number of oviposition events) of the three genotypes (in the following order: RR RS SS)
#' @export
#'
#' @examples
...
#' fitness_f_kdr(Pllin_kdr, m1p_kdr, m2p_kdr, TP)

fitness_f_kdr <- function(Pllin_kdr, m1p_kdr, m2p_kdr, FUN=TP){
